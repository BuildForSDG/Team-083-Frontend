            ...
            <Card plain>
              ...
              <CardFooter className={classes.justifyCenter}>
                <Button justIcon color="transparent" className={classes.margin5}>
                  <i className={classes.socials + FaTwitter} />
                </Button>
                <Button justIcon color="transparent" className={classes.margin5}>
                  <i className={classes.socials + FaInstagram} />
                  <Box as={FaInstagram} />
                </Button>
                <Button justIcon color="transparent" className={classes.margin5}>
                  <i className={classes.socials + FaFacebook} />
                </Button>
              </CardFooter>
            </Card>
          </GridItem>
          <GridItem xs={12} sm={12} md={4}>
            <Card plain>
              ...
              <CardFooter className={classes.justifyCenter}>
                ...
                <Button justIcon color="transparent" className={classes.margin5}>
                  <i className={classes.socials + FaLinkedin} />
                </Button>
              </CardFooter>
            </Card>
          </GridItem>
